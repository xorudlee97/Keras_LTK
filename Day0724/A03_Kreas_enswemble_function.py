...
Node_list = [3,14,15,9,26,5,3]

input1 = Input(shape=(3,))
dense1 = Dense(Node_list[0], activation='relu')(input1)
dense2 = Dense(Node_list[1], activation='relu')(dense1)
dense3 = Dense(Node_list[2], activation='relu')(dense2)
dense4 = Dense(Node_list[3], activation='relu')(dense3)
dense5 = Dense(Node_list[4], activation='relu')(dense4)
dense6 = Dense(Node_list[5], activation='relu')(dense5)
dense7 = Dense(Node_list[6], activation='relu')(dense6)

model = Model(input= input1, output=dense7)
# model.summary()
